...
const { resolveHttpAuthSchemeConfig, defaultCognitoIdentityProviderHttpAuthSchemeParametersProvider } = require("./auth/httpAuthSchemeProvider");
const { getRuntimeConfig } = require("./runtimeConfig");
const { AddCustomAttributes$, AddUserPoolClientSecret$, AdminAddUserToGroup$, AdminConfirmSignUp$, AdminCreateUser$, AdminDeleteUserAttributes$, AdminDeleteUser$, AdminDisableProviderForUser$, AdminDisableUser$, AdminEnableUser$, AdminForgetDevice$, AdminGetDevice$, AdminGetUser$, AdminInitiateAuth$, AdminLinkProviderForUser$, AdminListDevices$, AdminListGroupsForUser$, AdminListUserAuthEvents$, AdminRemoveUserFromGroup$, AdminResetUserPassword$, AdminRespondToAuthChallenge$, AdminSetUserMFAPreference$, AdminSetUserPassword$, AdminSetUserSettings$, AdminUpdateAuthEventFeedback$, AdminUpdateDeviceStatus$, AdminUpdateUserAttributes$, AdminUserGlobalSignOut$, AssociateSoftwareToken$, ChangePassword$, CompleteWebAuthnRegistration$, ConfirmDevice$, ConfirmForgotPassword$, ConfirmSignUp$, CreateGroup$, CreateIdentityProvider$, CreateManagedLoginBranding$, CreateResourceServer$, CreateTerms$, CreateUserImportJob$, CreateUserPoolClient$, CreateUserPool$, CreateUserPoolDomain$, CreateUserPoolReplica$, DeleteGroup$, DeleteIdentityProvider$, DeleteManagedLoginBranding$, DeleteResourceServer$, DeleteTerms$, DeleteUserAttributes$, DeleteUser$, DeleteUserPoolClient$, DeleteUserPoolClientSecret$, DeleteUserPool$, DeleteUserPoolDomain$, DeleteUserPoolReplica$, DeleteWebAuthnCredential$, DescribeIdentityProvider$, DescribeManagedLoginBrandingByClient$, DescribeManagedLoginBranding$, DescribeResourceServer$, DescribeRiskConfiguration$, DescribeTerms$, DescribeUserImportJob$, DescribeUserPoolClient$, DescribeUserPool$, DescribeUserPoolDomain$, ForgetDevice$, ForgotPassword$, GetCSVHeader$, GetDevice$, GetGroup$, GetIdentityProviderByIdentifier$, GetLogDeliveryConfiguration$, GetSigningCertificate$, GetTokensFromRefreshToken$, GetUICustomization$, GetUserAttributeVerificationCode$, GetUserAuthFactors$, GetUser$, GetUserPoolMfaConfig$, GlobalSignOut$, InitiateAuth$, ListDevices$, ListGroups$, ListIdentityProviders$, ListResourceServers$, ListTagsForResource$, ListTerms$, ListUserImportJobs$, ListUserPoolClients$, ListUserPoolClientSecrets$, ListUserPoolReplicas$, ListUserPools$, ListUsers$, ListUsersInGroup$, ListWebAuthnCredentials$, ResendConfirmationCode$, RespondToAuthChallenge$, RevokeToken$, SetLogDeliveryConfiguration$, SetRiskConfiguration$, SetUICustomization$, SetUserMFAPreference$, SetUserPoolMfaConfig$, SetUserSettings$, SignUp$, StartUserImportJob$, StartWebAuthnRegistration$, StopUserImportJob$, TagResource$, UntagResource$, UpdateAuthEventFeedback$, UpdateDeviceStatus$, UpdateGroup$, UpdateIdentityProvider$, UpdateManagedLoginBranding$, UpdateResourceServer$, UpdateTerms$, UpdateUserAttributes$, UpdateUserPoolClient$, UpdateUserPool$, UpdateUserPoolDomain$, UpdateUserPoolReplica$, VerifySoftwareToken$, VerifyUserAttribute$ } = require("./schemas/schemas_0");
...
const paginateAdminListUserAuthEvents = createPaginator(CognitoIdentityProviderClient, AdminListUserAuthEventsCommand, "NextToken", "NextToken", "MaxResults");

const paginateListGroups = createPaginator(CognitoIdentityProviderClient, ListGroupsCommand, "NextToken", "NextToken", "Limit");

const paginateListIdentityProviders = createPaginator(CognitoIdentityProviderClient, ListIdentityProvidersCommand, "NextToken", "NextToken", "MaxResults");

const paginateListResourceServers = createPaginator(CognitoIdentityProviderClient, ListResourceServersCommand, "NextToken", "NextToken", "MaxResults");

const paginateListUserPoolClients = createPaginator(CognitoIdentityProviderClient, ListUserPoolClientsCommand, "NextToken", "NextToken", "MaxResults");

const paginateListUserPools = createPaginator(CognitoIdentityProviderClient, ListUserPoolsCommand, "NextToken", "NextToken", "MaxResults");

const paginateListUsersInGroup = createPaginator(CognitoIdentityProviderClient, ListUsersInGroupCommand, "NextToken", "NextToken", "Limit");

const paginateListUsers = createPaginator(CognitoIdentityProviderClient, ListUsersCommand, "PaginationToken", "PaginationToken", "Limit");
