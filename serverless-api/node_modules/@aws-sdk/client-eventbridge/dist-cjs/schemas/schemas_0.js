...
const EventBridgeServiceException$ = [-3, _s, "EventBridgeServiceException", 0, [], []];
...
const IllegalStatusException$ = [-3, n0, _ISE,
    { [_e]: _c },
    [_m],
    [0]
];
...
const InternalException$ = [-3, n0, _IE,
    { [_e]: _se },
    [_m],
    [0]
];
...
const InvalidEventPatternException$ = [-3, n0, _IEPE,
    { [_e]: _c },
    [_m],
    [0]
];
...
const ManagedRuleException$ = [-3, n0, _MRE,
    { [_e]: _c },
    [_m],
    [0]
];
...
const OperationDisabledException$ = [-3, n0, _ODE,
    { [_e]: _c },
    [_m],
    [0]
];
...
const Connection$ = [3, n0, _Co,
    0,
    [_CA, _N, _CS, _SR, _AT, _CT, _LMT, _LAT],
    [0, 0, 0, 0, 0, 4, 4, 4]
];
exports.Connection$ = Connection$;
const ConnectionApiKeyAuthResponseParameters$ = [3, n0, _CAKARP,
    0,
    [_AKN],
    [0]
];
exports.ConnectionApiKeyAuthResponseParameters$ = ConnectionApiKeyAuthResponseParameters$;
const ConnectionAuthResponseParameters$ = [3, n0, _CARP,
    0,
...
const ConnectionOAuthClientResponseParameters$ = [3, n0, _COACRP,
    0,
    [_CID],
    [0]
];
exports.ConnectionOAuthClientResponseParameters$ = ConnectionOAuthClientResponseParameters$;
const ConnectionOAuthResponseParameters$ = [3, n0, _COARP,
    0,
    [_CPl, _AE, _HM, _OAHP],
...
const CreateConnectionAuthRequestParameters$ = [3, n0, _CCARP,
    0,
    [_BAPa, _OAP, _AKAP, _IHP, _CP],
...
const CreateEndpointResponse$ = [3, n0, _CERr,
    0,
...
const CreateEventBusRequest$ = [3, n0, _CEBR,
    0,
...
const DeleteEndpointResponse$ = [3, n0, _DERe,
    0,
    [],
    []
];
exports.DeleteEndpointResponse$ = DeleteEndpointResponse$;
const DeleteEventBusRequest$ = [3, n0, _DEBR,
    0,
    [_N],
    [0], 1
];
exports.DeleteEventBusRequest$ = DeleteEventBusRequest$;
const DeletePartnerEventSourceRequest$ = [3, n0, _DPESR,
    0,
    [_N, _Ac],
    [0, 0], 2
];
...
const DescribeConnectionConnectivityParameters$ = [3, n0, _DCCP,
    0,
    [_RP],
...
const DescribeConnectionRequest$ = [3, n0, _DCRes,
    0,
    [_N],
    [0], 1
];
exports.DescribeConnectionRequest$ = DescribeConnectionRequest$;
const DescribeConnectionResourceParameters$ = [3, n0, _DCRP,
    0,
    [_RCA, _RAA],
    [0, 0], 2
];
exports.DescribeConnectionResourceParameters$ = DescribeConnectionResourceParameters$;
const DescribeConnectionResponse$ = [3, n0, _DCResc,
    0,
...
const DescribeEndpointRequest$ = [3, n0, _DERes,
    0,
    [_N, _HR],
    [0, 0], 1
];
exports.DescribeEndpointRequest$ = DescribeEndpointRequest$;
const DescribeEndpointResponse$ = [3, n0, _DEResc,
    0,
...
const DescribeEventBusRequest$ = [3, n0, _DEBRe,
    0,
    [_N],
    [0]
];
exports.DescribeEventBusRequest$ = DescribeEventBusRequest$;
const DescribeEventBusResponse$ = [3, n0, _DEBRes,
    0,
...
const EnableRuleRequest$ = [3, n0, _ERR,
    0,
    [_N, _EBN],
    [0, 0], 1
];
...
const EndpointEventBus$ = [3, n0, _EEB,
    0,
    [_EBA],
    [0], 1
];
exports.EndpointEventBus$ = EndpointEventBus$;
const EventBus$ = [3, n0, _EBv,
    0,
    [_N, _Ar, _D, _Po, _CT, _LMT],
    [0, 0, 0, 0, 4, 4]
];
exports.EventBus$ = EventBus$;
const EventSource$ = [3, n0, _ES,
    0,
    [_Ar, _CB, _CT, _ET, _N, _St],
    [0, 0, 4, 4, 0, 0]
];
exports.EventSource$ = EventSource$;
const FailoverConfig$ = [3, n0, _FC,
    0,
    [_Pr, _Se],
    [() => Primary$, () => Secondary$], 2
];
exports.FailoverConfig$ = FailoverConfig$;
const HttpParameters$ = [3, n0, _HPt,
    0,
    [_PPV, _HP, _QSP],
    [64 | 0, 128 | 0, 128 | 0]
];
exports.HttpParameters$ = HttpParameters$;
const InputTransformer$ = [3, n0, _IT,
    0,
    [_ITn, _IPM],
    [0, 128 | 0], 1
];
...
const PartnerEventSource$ = [3, n0, _PESa,
    0,
    [_Ar, _N],
    [0, 0]
];
exports.PartnerEventSource$ = PartnerEventSource$;
const PartnerEventSourceAccount$ = [3, n0, _PESAa,
    0,
    [_Ac, _CT, _ET, _St],
    [0, 4, 4, 0]
];
...
exports.Rule$ = Rule$;
const RunCommandParameters$ = [3, n0, _RCP,
    0,
    [_RCT],
    [() => RunCommandTargets], 1
];
exports.RunCommandParameters$ = RunCommandParameters$;
const RunCommandTarget$ = [3, n0, _RCTu,
    0,
    [_K, _Va],
    [0, 64 | 0], 2
];
...
const TestEventPatternRequest$ = [3, n0, _TEPR,
    0,
    [_EP, _Ev],
    [0, 0], 2
];
exports.TestEventPatternRequest$ = TestEventPatternRequest$;
const TestEventPatternResponse$ = [3, n0, _TEPRe,
    0,
    [_Res],
    [2]
];
...
const UpdateConnectionAuthRequestParameters$ = [3, n0, _UCARP,
    0,
    [_BAPa, _OAP, _AKAP, _IHP, _CP],
...
const UpdateEndpointRequest$ = [3, n0, _UER,
    0,
...
const UpdateEndpointResponse$ = [3, n0, _UERp,
    0,
...
const UpdateEventBusRequest$ = [3, n0, _UEBR,
    0,
    [_N, _KKI, _D, _DLC, _LC],
    [0, 0, 0, () => DeadLetterConfig$, () => LogConfig$]
];
exports.UpdateEventBusRequest$ = UpdateEventBusRequest$;
const UpdateEventBusResponse$ = [3, n0, _UEBRp,
    0,
