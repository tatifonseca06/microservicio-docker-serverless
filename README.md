...
La imagen está publicada en Docker Hub. Para usarla sin necesidad de buildear:

```bash
docker run -p 3000:3000 tatifonseca0657/hello-docker-api
```

[Ver en Docker Hub](https://hub.docker.com/r/tatifonseca0657/hello-docker-api)
